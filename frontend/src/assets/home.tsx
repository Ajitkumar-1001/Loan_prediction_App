...
const Home: React.FC =()=>{ 
    ...
    return(
        <div  className="min-w-screen min-h-screen flex flex-col md:flex-row gap-6 items-top bg-gradient-to-br from-sky-950 to-blue-350">
        <motion.div className="max-w-4xl m-10 mx-auto px-6 py-12 text-gray-200 font-sans leading-relaxed" variants={containerprops} initial ="hidden" animate={control1}>
